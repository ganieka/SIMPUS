...
<html lang="en"> 
  ...
  <body style="font-family:Poppins"> 
    ...
    <?php 
      $data = mysqli_query($mysqli, "SELECT * FROM `books`"); 
              ...
              <tr> 
                ...
                <td> 
                  <div class="btn btn-link btn-sm btn-rounded"> 
                    <?php echo "<a href='reqbuku.php?bid=".$row['bid']."&user=".$user."'>Request</a>";?>
                  </div>
                </td>
              </tr> 
      <?php }?> 
      ...
      <?php while($row=mysqli_fetch_assoc($res)) 
              {?> 
                <tr> 
                  ...
                  <td> 
                    <div class="btn btn-link btn-sm btn-rounded"> 
                      <?php echo "<a href='reqbuku.php?bid=".$row['bid']."&user=".$user."'>Request</a>";?></td> 
                    </div> 
                </tr> 
        <?php }?>
              </tbody> 
