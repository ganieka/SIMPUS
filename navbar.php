    ...
    ?>
      ...
      `</li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="library.php">Daftar Buku</a>
          <a class="dropdown-item" href="daftarreq.php">Daftar Request</a>
          <a class="dropdown-item" href="dafreturn.php">Daftar Pengembalian</a>
          <a class="dropdown-item" href="dafpinjaman.php">Daftar Pinjaman</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="library.php" >Daftar Buku</a>
        </li>
      </ul>
          <?php
        }
